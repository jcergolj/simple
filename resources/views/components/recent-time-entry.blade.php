        ...
        <div class="sm:hidden">
            ...
            <div class="flex flex-wrap gap-2">
                ...
                @elseif($runningTimer)
                    <button type="button"
                            disabled
                            class="bg-gray-100 text-gray-400 px-2 py-1 rounded text-xs font-medium cursor-not-allowed inline-flex items-center space-x-1"
                ...
                @else
                    <form action="{{ route('turbo.running-timer-session.store') }}" method="POST" data-turbo-frame="timer-widget" class="inline">
                        ...
                        <button type="submit"
                                class="bg-green-100 hover:bg-green-200 text-green-700 px-2 py-1 rounded text-xs font-medium transition-colors inline-flex items-center space-x-1">
                            <svg class="h-3 w-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z"></path>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                ...
                <a href="{{ route('turbo.time-entries.edit', $entry) }}"
                   class="bg-blue-100 hover:bg-blue-200 text-blue-700 px-2 py-1 rounded text-xs font-medium transition-colors inline-flex items-center space-x-1"
                ...
                <a href="{{ route('time-entries.destroy', ['timeEntry' => $entry, 'is_recent' => true]) }}"
                   ...
                   class="bg-red-100 hover:bg-red-200 text-red-700 px-2 py-1 rounded text-xs font-medium transition-colors inline-flex items-center space-x-1"
