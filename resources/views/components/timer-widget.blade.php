    ...
    @else
        <div class="p-8" data-controller="keyboard-shortcuts">
            <div class="text-center">
                <h2 class="text-2xl font-bold text-gray-900 mb-6">{{ __('Start New Timer') }}</h2>
                    ...
                    <form action="{{ route('turbo.running-timer-session.store') }}" method="POST" data-turbo-frame="timer-widget">
                        ...
                        <div class="flex justify-center">
                            <button type="submit" class="bg-green-600 hover:bg-green-700 text-white px-8 py-4 rounded-lg font-medium flex items-center justify-center space-x-3 transition-colors focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2" data-keyboard-shortcuts-target="startButton" title="{{ __('Start Timer') }} (Ctrl+Shift+S)">
