    ...
    <div class="space-y-8">
        ...
        <div class="hero bg-gradient-to-r from-primary/5 to-secondary/5 rounded-xl">
            <div class="hero-content text-center">
                <div class="max-w-md">
                    <h1 class="text-3xl font-bold">{{ __('Project Details') }}</h1>
                    <p class="py-2 text-base-content/70">{{ __('View detailed information about this project.') }}</p>
                </div>
            </div>
        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="font-medium">
                                            @if($project->client->hourly_rate)
                                                @php
                                                    $currency = App\Enums\Currency::from($project->client->hourly_rate->currency);
                                                @endphp
                                                {{ $currency->symbol() }}{{ number_format($project->client->hourly_rate->amount, 2) }}/hr
                                            @else
                    ...
                    <div class="card bg-base-200 shadow-sm">
                        <div class="card-body">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <a href="{{ route('time-entries.index', ['project_id' => $project->id]) }}" class="btn btn-sm btn-primary">View All</a>
                            </div>
                                ...
                                <table class="table table-zebra">
                                    ...
                                    <tbody>
                                        @foreach($project->timeEntries->take(5) as $timeEntry)
                                            <tr>
                                                <td>
                                                    <div class="font-medium">{{ $timeEntry->start_time->format('M j, Y') }}</div>
                                                    <div class="text-sm text-base-content/70">{{ $timeEntry->start_time->format('g:i A') }}</div>
                                                </td>
                                                <td>
