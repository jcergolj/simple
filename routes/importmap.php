...
Importmap::pin('@hotwired/turbo', to: '/js/vendor/@hotwired--turbo.js'); // @hotwired/turbo@8.0.18 downloaded from https://ga.jspm.io/npm:@hotwired/turbo@8.0.18/dist/turbo.es2017-esm.js
Importmap::pin('laravel-echo', to: '/js/vendor/laravel-echo.js'); // laravel-echo@2.2.4 downloaded from https://ga.jspm.io/npm:laravel-echo@2.2.4/dist/echo.js
