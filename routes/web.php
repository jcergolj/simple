...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('timer-session', [TimerSessionController::class, 'show'])->name('timer-session.show');
    Route::post('timer-session', [TimerSessionController::class, 'store'])->name('timer-session.store');
    Route::patch('timer-session', [TimerSessionController::class, 'update'])->name('timer-session.update');
    Route::delete('timer-session', [TimerSessionController::class, 'destroy'])->name('timer-session.destroy');
